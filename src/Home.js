       ...
       return(
            ...
            <div style={styles.menuList} id='menu-list'>
                <div style={styles.titleBar}>
                    ...
                    <img alt="battery" style={styles.battery} src="https://cdn-icons-png.flaticon.com/512/41/41412.png"></img>
                </div>
                <ListGroup style={{borderRadius:'0'}}>
                    <ListGroup.Item style={{border:'0',padding: '0.2rem 0.6rem'}} className={this.props.activeItem==='Songs'?'active':''}>
                        Songs {this.props.activeItem==='Songs'?<span style={{float:'right' ,fontWeight:'bold'}}>&gt;</span>:''}
                    </ListGroup.Item>
                    <ListGroup.Item style={{border:'0',padding: '0.2rem 0.6rem'}} className={this.props.activeItem==='Albums'?'active':''}>
                        Albums {this.props.activeItem==='Albums'?<span style={{float:'right' ,fontWeight:'bold'}}>&gt;</span>:''}
                    </ListGroup.Item>
